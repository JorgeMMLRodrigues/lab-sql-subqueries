...
-- customers email and name from canada
-- customer.customer_id / customer.address_id / customer.first_name / customer.last_name
-- address.address_id / city_id
-- city.city_id / city.country_id
-- country.country_id / country.country - name
...
-- actor with highest movie count
...
-- most profitable customer and the films the customer rents. 
-- customer.customer_id / customer.first_name / customer.last_name
-- payment.customer_id / payment.rental_id
-- rental.rental_id / rental.customer_id / rental.inventory_id
-- inventory.film_id / inventory.inventory_id
-- film.film_id / film.title
...
-- customer_id, total_amount_spent of clients that spent more than average of the total_amount_spent ofr each customer
-- customer.customer_id
-- payments.customer_id / payments.amount
